			...
			<div class="panel-body">
                    ...
                    <div class="col-md-2">
                        <div class="yrm-switch-wrapper">
                            <label class="yrm-switch">
                                <input type="checkbox" id="yrm-dont-delete-data" name="yrm-dont-delete-data" class="yrm-accordion-checkbox" <?php echo esc_attr($dontDeleteData); ?> >
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-2">
                        <div class="yrm-switch-wrapper">
                            <label class="yrm-switch">
                                <input type="checkbox" id="yrm-hid-find-and-replace-menu" name="yrm-hid-find-and-replace-menu" class="" <?php echo esc_attr($farMenu); ?> >
                                <span class="yrm-slider yrm-round"></span>
                            </label>
                        </div>
                    </div>
